...
namespace Anywhere.ArcGIS.Operation
{
    ...
    {
        public QueryRelatedRecords(ArcGISServerEndpoint endpoint, Action beforeRequest = null, Action<string> afterRequest = null)
            : base(endpoint.RelativeUrl.Trim('/') + "/" + Operations.QueryRelatedRecords, beforeRequest, afterRequest)
        {
